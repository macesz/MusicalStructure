    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nowPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nowPlayingIntent = new Intent(Albums.this,
                        NowPlaying.class);
        ...
        artist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent artistIntent = new Intent(Albums.this,
                        Artist.class);
        ...
        lyrics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent lyricsIntent = new Intent(Albums.this,
                        Lyrics.class);
        ...
        playlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link Lyrics Activity]
                Intent playlistIntent = new Intent(Albums.this,
                        PlayList.class);
        ...
        albums.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link Lyrics Activity]
                Intent albumsIntent = new Intent(Albums.this,
                        Albums.class);
