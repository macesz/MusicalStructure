    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nowPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nowPlayingIntent = new Intent(Lyrics.this,
                        NowPlaying.class);
        ...
        artist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent artistIntent = new Intent(Lyrics.this,
                        Artist.class);
        ...
        lyrics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent lyricsIntent = new Intent(Lyrics.this,
                        Lyrics.class);
        ...
        playlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link Lyrics Activity]
                Intent playlistIntent = new Intent(Lyrics.this,
                        PlayList.class);
        ...
        albums.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link Lyrics Activity]
                Intent albumsIntent = new Intent(Lyrics.this,
                        Albums.class);
